#!/usr/bin/env python3
"""
muroto_offshore_current_dashboard_data.js を生成するスクリプト
============================================================
...
csv_path   = script_dir.parent / "data" / "muroto_offshore_current_all.csv"
js_path    = script_dir.parent / "data" / "js" / "muroto_offshore_current_dashboard_data.js"
...
def main():
    ...
    print(f"✅ muroto_offshore_current_dashboard_data.js を更新しました（{row_count:,} 行）")
    print(f"   保存先: {js_path}")
